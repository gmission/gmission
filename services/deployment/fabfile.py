...
REMOTE_ROOTS = {
    'csp-aliyun':'/home/csp_team/nginx_www/gmission/services',
}
...
def restart_webserver(remote_root):
    with cd(remote_root):
        # run('touch 0deployment/uwsgi/vassals/szww.ini')
        # run('touch /home/csp_team/nginx_www/gmission/0deployment/uwsgi/vassals/zhosr.ini')
        # run('touch 0deployment/uwsgi/vassals/hkust-gmission.ini')
        run('touch /home/csp_team/nginx_www/gmission/0deployment/uwsgi/vassals/services.ini')
